...
/********
     ﾒｻﾎｻﾐｴ
	   ...
	   ｶ猥ｻｶﾁ
  	*********/
    void (*set_level)(pLED_Class, const int led_n, const led_bit led_level);/*******ｺｯﾊﾖｸﾕ・ｬﾗ｢ﾒ簑ｨｺﾅﾐ靨ｪｼﾓﾔﾚﾊｲﾃｴｵﾘｷｽ**********/
...
extern void led_out_gpio(uint8_t arg_int, int led_n);/********ｽﾓｿﾚﾈｫｾﾖﾉｬﾖｻﾓﾃｶｨﾒ・********/
